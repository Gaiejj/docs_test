...
.. tab-set::
    ...
    .. tab-item:: Proposition 1
      ...
      .. card:: 
         ...
         where :math:`\epsilon_{\pi_{k+1}}=\max_s\left|\mathbb{E}_{a \sim \pi_{k+1}}\left[A_{\pi_k}(s, a)\right]\right|`.
     ...
     .. tab-item:: Terminal config style
            ...
            .. code-block:: guess
               :linenos:
                ...
                cd examples
                python train_on_policy.py --env-id Hopper-v4 --algo CPO --parallels 4 --seed 0.
...
:bdg-ref-success-line:`Click here to jump to CPO Theorem<Theorem 1>`

:bdg-ref-success-line:`Click here to jump to Code with OmniSafe<Code_with_OmniSafe>`
...
.. tab-set::
    ...
    .. tab-item:: Proof for Lemma 1
      ...
      .. card:: 
         ...
         .. math:: (1-\gamma) \mathbb{E}_{s \sim \mu}[f(s)]+\mathbb{E}_{\tau \sim \pi}\left[\gamma f\left(s^{\prime}\right)\right]-\mathbb{E}_{s \sim d_\pi}[f(s)]
    ...
    .. tab-item:: Proof for Lemma 2
      ...
      .. card:: 
         ...
         .. math:: J(\pi)=\frac{1}{1-\gamma} \mathbb{E}_{\tau \sim \pi}\left[R\left(s, a, s^{\prime}\right)\right]\tag{18}
         .. math:: =\mathbb{E}_{s \sim \mu}[f(s)]+\frac{1}{1-\gamma} \mathbb{E}_{\tau \sim \pi}\left[R\left(s, a, s^{\prime}\right)+\gamma f\left(s^{\prime}\right)-f(s)\right]
